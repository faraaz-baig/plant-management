        ...
        <v-layout class="my-16">
            <v-flex xs10 sm10 md6 lg5 class="mx-auto">
                <v-card outlined color="#e4e4e4" class="pa-5">
                    <v-card-title class="text-h5 font-weight-bold">{{ submitButtonCaption }}</v-card-title>
                    <v-card-subtitle class="py-2">{{`${submitButtonCaption} to access enterprise owner features`}}</v-card-subtitle>
                    <v-card-text>
                        <v-form>
                            <v-text-field v-model.trim="email" type="email" label="Email" required></v-text-field>
